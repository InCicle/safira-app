...
import { links, ModulesWeb } from '@/utils/links';
import { MODULES } from '@/interfaces/Modules';

import SteponeIcon from '@/assets/tutorials/SteponeIcon';
import ScheduleIcon from '@/assets/tutorials/ScheduleIcon';
import AdmissionIcon from '@/assets/tutorials/AdmissionIcon';
import PersonalDepartmentIcon from '@/assets/tutorials/PersonalDepartmentIcon';
import EndoMarketingIcon from '@/assets/tutorials/EndoMarketingIcon';
import FeedbackIcon from '@/assets/tutorials/FeedbackIcon';
import ProjectManagementIcon from '@/assets/tutorials/ProjectManagementIcon';
import CompetencyIcon from '@/assets/tutorials/CompetencyIcon';
import SocialNetworkIcon from '@/assets/tutorials/SocialNetworkIcon';
import PolicyIcon from '@/assets/tutorials/PolicyIcon';
import OkrIcon from '@/assets/tutorials/OkrIcon';
import TaskIcon from '@/assets/tutorials/TaskIcon';
import InCheckIcon from '@/assets/tutorials/InCheckIcon';
import SettingsIcon from '@/assets/tutorials/SettingsIcon';
import InpontoIcon from '@/assets/tutorials/InpontoIcon';
import ManagerIcon from '@/assets/tutorials/ManagerIcon';
import OmbudsmanIcon from '@/assets/tutorials/OmbudsmanIcon';
import HRConnectIcon from '@/assets/tutorials/HRConnectIcon';
import ClimateResearchIcon from '@/assets/tutorials/ClimateResearchIcon';
import RecruitmentIcon from '@/assets/tutorials/RecruitmentIcon';
import ProfileMapIcon from '@/assets/tutorials/ProfileMapIcon';
...
export type ModulesType = {
  ...
  url: string | null;
  slug: string;
  accountTypes: IMe['type'][];
  description: {
    [K in IMe['type']]: string | null;
  };
  permission?: string;
  enableOnlyTo?: string[];
...
export const UserMenuModules: ModulesType[] = [
  {
    title: 'schedule',
...
export type FilterModulesType = {
  ...
  slug: MODULES;
  icon: string;
  linkKey: keyof ModulesWeb | 'disabled' | null;
