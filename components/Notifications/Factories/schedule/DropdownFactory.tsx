...
// @ts-ignore
const ScheduleDropdownNotificationFactory: React.FC<React.PropsWithChildren<IProps>> = ({ notificationItem }) => {
  // @ts-ignore
  ...
  const renderActions = () => {
    ...
    switch (notificationItem.type) {
      ...
      case notificationType.NEW_TASK_INVITATION:
        return (
          <NotificationContainer
            url={`${links.web.schedule}/taskmanager?task_id=${notificationItem.common.task_id}`}
            notification={notificationItem}
          >
            <NotificationContentText notification={notification}>
      ...
      case notificationType.TASK_STATUS_UPDATE:
        return (
          ...
          >
            <NotificationContentText notification={notification}>
              <NotificationHighlight>{notification.sender.name}</NotificationHighlight> alterou o status da tarefa{' '}
              <NotificationHighlight>"{notification.common.task_title}"</NotificationHighlight> para{' '}
      ...
      case notificationType.ADDED_SCHEDULE:
        return (
          <NotificationContainer url={`${links.web.schedule}`} notification={notification}>
            <NotificationContentText notification={notification}>
      ...
      case notificationType.NEW_EVENT:
        return (
          <NotificationContainer
            notification={notification}
            url={`${links.web.schedule}/?action=open_event_modal&event_id=${notification.common.event_id}`}
          >
            <NotificationContentText notification={notification}>
...
export default ScheduleDropdownNotificationFactory;
