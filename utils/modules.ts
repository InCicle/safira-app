import { links, ModulesWeb } from '../config/links';
import { MeProps } from '../interfaces/Me';
import { MODULE_TYPES } from '../interfaces/Notification';

import SteponeIcon from '../components/InHeader/components/icons/SteponeIcon';
import ScheduleIcon from '../components/InHeader/components/icons/ScheduleIcon';
import AdmissionIcon from '../components/InHeader/components/icons/AdmissionIcon';
import PersonalDepartmentIcon from '../components/InHeader/components/icons/PersonalDepartmentIcon';
import EndoMarketingIcon from '../components/InHeader/components/icons/EndoMarketingIcon';
import FeedbackIcon from '../components/InHeader/components/icons/FeedbackIcon';
import ProjectManagementIcon from '../components/InHeader/components/icons/ProjectManagementIcon';
import CompetencyIcon from '../components/InHeader/components/icons/CompetencyIcon';
import SocialNetworkIcon from '../components/InHeader/components/icons/SocialNetworkIcon';
import PolicyIcon from '../components/InHeader/components/icons/PolicyIcon';
import OkrIcon from '../components/InHeader/components/icons/OkrIcon';
import TaskIcon from '../components/InHeader/components/icons/TaskIcon';
import InCheckIcon from '../components/InHeader/components/icons/InCheckIcon';
import SettingsIcon from '../components/InHeader/components/icons/SettingsIcon';
import InpontoIcon from '../components/InHeader/components/icons/InpontoIcon';
import OmbudsmanDisabledIcon from '../components/InHeader/components/icons/OmbudsmanDisabledIcon';
import ManagerIcon from '../components/InHeader/components/icons/ManagerIcon';
import ClimateResearchDisabledIcon from '../components/InHeader/components/icons/ClimateResearchDisabledIcon';
